...
const typographyVariants = tv({
  ...
  variants: {
    variant: {
      ...
      h3: "font-sans-medium text-xl leading-[26px]",
      h4: "font-sans-medium text-lg leading-6",
      body: "text-base leading-6",
      bodyBold: "font-sans-medium text-base leading-6",
      small: "text-sm leading-5",
      smallBold: "font-sans-medium text-sm leading-5",
      label: "font-sans-medium text-xs leading-4 tracking-wide",
