...
The typography panel on `02-visual-identity-system.png` preserves the approved hierarchy and composition but predates the final open-source family selection. [`BRAND.md`](../BRAND.md) and [`tokens.json`](../tokens.json) are authoritative for Geist and Newsreader.
